...
public class JWETest {
  ...
  public void appendixA1Test() throws Exception {
     ...
     *
     ...
     Developer note: RSAES-OAEP encryption result lengths are expected to match
     ...
     * A.1.6.  Content Encryption
     ...
     a 128-bit Authentication Tag output.
     */
  ...
  public void appendixA2Test() throws Exception {
    ...
    /**
     ...
     Developer note: encryption result lengths are expected to match
     but not the contents
     */
