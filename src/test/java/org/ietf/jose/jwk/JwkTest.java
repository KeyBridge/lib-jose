...
public class JwkTest {
  ...
  public void ecPublicKeyTest() throws IOException {
    ...
    EllipticCurveJwk keyReconverted = (EllipticCurveJwk) new JsonbUtility().unmarshal(new JsonbUtility().marshal(ecKey), JsonWebKey.class);
  ...
  public void rsaPublicKeyTest() throws IOException {
    ...
    RsaPublicJwk keyReconverted = (RsaPublicJwk) new JsonbUtility().unmarshal(new JsonbUtility().marshal(rsaKey), JsonWebKey.class);
  ...
  public void rsaPrivateKeyTest() throws IOException {
    ...
    RsaPrivateJwk keyReconverted = (RsaPrivateJwk) new JsonbUtility().unmarshal(new JsonbUtility().marshal(rsaKey), JsonWebKey.class);
    assertEquals(rsaKey, keyReconverted);
  }
