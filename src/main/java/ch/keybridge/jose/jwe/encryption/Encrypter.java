...
public interface Encrypter {
  ...
  /**
   * Encrypt the provided payload bytes using the provided initialisation vector, additional authenticated data,
   * and key.
   *
   * @param payload payload bytes
   * @param iv      initialisation vector. Implementations should generate a valid initialisation vector automatically
   *                in case a null IV is provided.
  ...
  /**
   * Decrypt the ciphertext using the provided initialisation vector, additional authenticated data, and key.
