...
public enum EKeyManagementAlgorithm {
  ...
  EKeyManagementAlgorithm(String joseAlgorithmName, String javaAlgorithmName, AlgorithmParameterSpec
   ...
   * <p>
   * Returns UNSUPPORTED for incorrect 'alg' values or unsupported key management algorithms
   *
   * @param alg
   * @return
   */
